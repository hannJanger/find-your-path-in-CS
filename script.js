...
function showQuestionTwo() {
    document.getElementById("question").innerHTML = `
        ...
        <button onclick="chooseQ2('software')">How apps and software are built behind the scenes</button>
        ...
        <button onclick="chooseQ2('cybersecurity')">How hackers find weaknesses and how systems defend against them</button>
...
function showQuestionThree() {
    document.getElementById("question").innerHTML = `
        ...
        <button onclick="chooseQ3('cybersecurity')">Check whether something could have caused a security problem</button>
...
function showQuestionFive() {
    document.getElementById("question").innerHTML = `
        ...
        <button onclick="chooseQ5('software')">How smoothly everything works behind the scenes</button>
...
function showResult() {
    ...
    if (highestScore === scores.software) {
        ...
        enjoy = `
            ...
            <li>Creating useful software</li>
        `;
    }
        ...
        enjoy = `
            ...
            <li>Investigating security problems</li>
        ...
        enjoy = `
            ...
            <li>Designing user-friendly experiences</li>
